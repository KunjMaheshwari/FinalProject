...
public class ExcelUtility {
	...
	public static void writeBikeDataToExcel(String filePath, List<String> names, List<String> prices,
			List<String> launchDates) throws IOException {
